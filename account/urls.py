...
urlpatterns = [
    ...
    path('resend_code/', views.ResendOtpCodeAPIView.as_view(), name='resend_code'),
    path('request_reset_password/', views.PasswordResetAPIView.as_view(), name='request_reset_password'),
    path('reset-password/<str:token>/', views.ConfirmResetPasswordAPIView.as_view(), name='confirm-reset-password'),
